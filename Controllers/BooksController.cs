...
namespace Maxim_Cazacu_Laborator2.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var maxim_Cazacu_Laborator2Context = _context.Book.Include(b => b.Genre);
            return View(await maxim_Cazacu_Laborator2Context.ToListAsync());
        }
